...
const loadGruntTtasks = require('load-grunt-tasks');

module.exports = (grunt) => {
  loadGruntTtasks(grunt); // load all the grunt module
  ...
  grunt.registerTask('default', ['clean:dist', 'copy:src_to_dist', 'copy:pluginDef', 'copy:img_to_dist', 'string-replace', 'babel', 'sass']);
};
